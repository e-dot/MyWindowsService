...
IF NOT EXIST "%SERVICE_PATH%start.bat" GOTO START_BAT_NOT_FOUND
IF NOT EXIST "%SERVICE_PATH%stop.bat" GOTO STOP_BAT_NOT_FOUND
...
:START_BAT_NOT_FOUND
ECHO [%TIME%] %~n0 : ERROR : start command not found: "%SERVICE_PATH%start.bat" >&2
EXIT /B 3

:STOP_BAT_NOT_FOUND
ECHO [%TIME%] %~n0 : ERROR : stop command not found: "%SERVICE_PATH%stop.bat" >&2
EXIT /B 4
